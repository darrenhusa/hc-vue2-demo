...
$data1 = [['label' => 'DCP', 'color' => '#5B9BD5', 'showDataLabels' => false,  'values' => [142,	114, 155, 150, 141,	143, 165, 189, 306, 343, 339, 377, 464, 483, 443, 392, 359, 365, 343, 337, 326, 265, 324, 279, 253, 249, 149, 141, 127, 133, 127]],
         ['label' => 'GRAD', 'color' => '#ED7D31', 'showDataLabels' => false, 'values' => ['', '', '', '', '', '', '', '', '', '', '', 115, 171, 149, 129,	196, 216, 157, 194,	184, 170, 164, 152,	169, 220, 256, 214, 190, 169, 138, 106]],
         ['label' => 'TRAD - FT', 'color' => '#A5A5A5',  'showDataLabels' => true, 'values' => [377, 391, 350,	357, 313, 286, 327,	319, 300, 267, 313, 326, 383, 405, 435, 435, 448, 493, 565, 543, 493, 475, 528, 496, 497, 443, 403, 353, 384, 409, 370]],
         ['label' => 'TRAD - PT', 'color' => '#FFCC00', 'showDataLabels' => false, 'values' => [587,	591, 598, 618, 578,	559, 497, 468, 397,	365, 353, 323, 312,	301, 255, 248, 218,	199, 210, 187, 153,	129, 132, 85, 72, 46, 37, 31, 29, 23, 25]],
         ['label' => 'Grand Total', 'color' => '#4472C4', 'showDataLabels' => true, 'values' => [1106,	1096, 1103, 1125, 1032, 988, 989, 976, 1003, 975, 1005, 1141, 1330, 1338, 1262,	1271, 1241,	1214, 1312,	1251, 1142,	1033, 1136,	1029, 1042,	994, 803, 715, 709, 703, 628]],
];
